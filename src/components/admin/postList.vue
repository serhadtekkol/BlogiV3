<template>
  <div class="container mx-auto text-sm pb-10 pt-10">
    <div class="p-6 bg-gray-600 rounded-md">
      ...
      <div
        ...
        class="bg-gray-100 mb-4 rounded-md px-2 py-4 flex shadow-lg border-l-4 border-orange-500"
      >
        ...
        <div class="flex-none w-32 text-center inline-block self-center align-middle">
          <button
            ...
            class="h-8 w-8 px-1.5 py-1.5 rounded-md bg-gray-600/40 hover:bg-gray-700 text-white mx-1"
          >
  ...
  <div
    ...
    class="z-48 grid place-items-center fixed top-0 w-screen h-screen bg-slate-600/40 backdrop-blur-sm mx-auto text-center"
  >
